Shader "URP/Chapter10/Reflection"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float3 reflectColor = SAMPLE_TEXTURECUBE(_Cubemap, sampler_Cubemap, reflectDir).xyz;
                //根据反射强度混合反射颜色和物体自身颜色
                diffuse = lerp(diffuse, reflectColor, _ReflectAmount);
