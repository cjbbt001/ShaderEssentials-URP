Shader "URP/Chapter7/MaskTexture"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float specularMask = SAMPLE_TEXTURE2D(_SpecularMask, sampler_SpecularMask, i.uv).xyz;
                ...
                float3 specular = (light.color * _SpecularColor.rgb * specularMask) * pow(max(dot(worldNormal, h), 0), _Shiness);
